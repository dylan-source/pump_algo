...
#     print(is_domain_allowed("https://x.com/UndisclosedDocs/status/1875762642356506909"))  # Expected False
#     print(is_domain_allowed("https://t.co/YzAINJfoQR"))                                   # Expected False
#     print(is_domain_allowed("https://x.com/swarms_edu_ai"))  
