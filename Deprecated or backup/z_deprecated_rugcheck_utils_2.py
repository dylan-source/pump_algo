######### Rugcheck error that periodically pops up
# 
# 2024-12-29 15:01:26 [ERROR] Failed to fetch token details: 400 {"error":"failed to generate report cached"}
# 2024-12-29 15:01:26 [ERROR] Failed to fetch token details.
# Traceback (most recent call last):
#   File "/Users/dylanmartens/Documents/Coding/Pump sniping/pump_sniping_trade_new_listener_1/main.py", line 140, in <module>
#     asyncio.run(main())
...
#            ^^^^^^^^^^^^^^^
#   File "/Users/dylanmartens/Documents/Coding/Pump sniping/pump_sniping_trade_new_listener_1/main.py", line 135, in main
#     await asyncio.gather(producer_task, consumer_task)
#   File "/Users/dylanmartens/Documents/Coding/Pump sniping/pump_sniping_trade_new_listener_1/main.py", line 48, in consume_queue
...
async def rugcheck_analysis(httpx_client: httpx.AsyncClient, token_mint_address: str, download_image: bool = False, save_path: str = "./images"):
    ...
    try:
        ...
        metadata["twitter_handle"] = parse_twitter_handle(metadata["twitter_url"])
